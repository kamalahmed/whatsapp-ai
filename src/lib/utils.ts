 ...
 * @returns A single class name that can be used to apply CSS classes to an element.
 */
...
/**
 * Convert milliseconds to a human-friendly date string.
 * @param date_ms - The number of milliseconds since the Unix epoch.
...
/**
Returns a human-friendly relative date and time for the given message, compared to the previous message.
@param message - the current message
@param previousMessage - the previous message, or undefined if this is the first message in the thread
@returns a string representing the relative date and time
 */
